...
##
## Cross-Platform Makefile generated from 'PlaneOfCraftiness.mk' project file.
##
...
##	project - Re-generates project files based PlaneOfCraftiness.mk's variables.
##

include PlaneOfCraftiness.mk
export
